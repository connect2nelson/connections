...
(function() {
  $(document).ready(function() {
    var onHoverIn, onHoverOut;
    $('#search_field').bind('railsAutocomplete.select', function(event, data) {
      return window.location = "/consultants/" + data.item.employee_id;
    });
    onHoverIn = function() {
      var texts;
      $(this).find('.label').addClass('highlight');
      texts = $(this).find('.label').map(function() {
        return this.innerText;
      }).get();
      return $('.skills .label').each(function() {
    ...
    onHoverOut = function() {
      return $('.label').removeClass('highlight');
    };
    return $('.matches li').hover(onHoverIn, onHoverOut);
  });
